...
#    Updated: 2019/08/01 20:17:01 by ocrossi     ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
NAME_SRC			=	debug.c lib_plus.c main.c option.c error.c \
						...
						debug2.c path_sorter2.c path_sorter3.c tab_potential_paths.c\
						output.c opti_len_paths.c opti_len_paths1.c opti_path1.c opti_paths.c path_sorter.c path_sorter_utils.c\
						output_utils.c output_ants.c sort_paths_opti.c\
						tab_path_creator.c generic_sorter.c print_fcts.c tab_path_manager.c\
						sort_paths_opti2.c tab_path_vp.c  tab_path2_vp.c tab_path1_vp.c\
